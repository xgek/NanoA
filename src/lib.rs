...
#[derive(Debug)]
pub struct AIPainterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AIPainterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AIPainter processing");
    
    let mut processor = AIPainterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AIPainterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AIPainterProcessor::new(false);
